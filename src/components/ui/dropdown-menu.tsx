...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "data-[state=open]:bg-surface-overlay data-[state=open]:text-text-primary",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[10rem] overflow-hidden rounded-xl border border-border-strong",
      "bg-surface-raised p-1 shadow-elevation-4",
...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[11rem] overflow-hidden rounded-xl border border-border-strong",
        "bg-surface-raised p-1 shadow-elevation-4",
        "data-[state=open]:animate-scale-in data-[state=closed]:animate-fade-in",
        className
      )}
...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center gap-2.5 rounded-lg px-3 py-2 text-sm",
      "outline-none transition-colors duration-100",
      "focus:bg-surface-overlay",
      "data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      destructive
        ? "text-destructive focus:bg-destructive-muted/30"
