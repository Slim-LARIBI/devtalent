...
type MissionVisibility = "PRIVATE" | "ORGANIZATION";
...
export default function NewMissionPage() {
  ...
  const [form, setForm] = useState({
    ...
    missionType: "LONG_TERM" as MissionType,
    contractType: "CONSULTANT" as ContractType,
    seniorityRequired: "SENIOR" as ExpertLevel,
    yearsOfExperience: "",
    duration: "",
    startDate: "",
    deadline: "",
    ...
    publishNow: true,
    visibility: "PRIVATE" as MissionVisibility,
  });
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const result = await createMissionAction(form);
  ...
  const visibilityLabel =
    form.visibility === "ORGANIZATION" ? "Shared with organization" : "Private mission";
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-text-secondary">
                Publish a premium mission brief with clear project scope, candidate requirements,
                funding details, and organization visibility settings.
              </p>
            </div>
            ...
            <div className="grid gap-5">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Lead monitoring and evaluation design for an EU-funded governance programme."
                  className="w-full rounded-xl border border-border bg-background px-4 py-3 text-sm outline-none transition placeholder:text-text-muted focus:border-brand"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={7}
                  placeholder="Describe the project, responsibilities, expected deliverables, reporting line, and candidate profile."
                  className="w-full rounded-xl border border-border bg-background px-4 py-3 text-sm outline-none transition placeholder:text-text-muted focus:border-brand"
                />
              </div>
            </div>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Rabat or remote within MENA"
                  className="w-full rounded-xl border border-border bg-background px-4 py-3 text-sm outline-none focus:border-brand"
                />
              </div>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateField("seniorityRequired", e.target.value as ExpertLevel)
                  }
                  className="w-full rounded-xl border border-border bg-background px-4 py-3 text-sm outline-none focus:border-brand"
                >
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  rows={4}
                  placeholder="Monitoring & Evaluation, governance reform, donor reporting, performance frameworks..."
                  className="w-full rounded-xl border border-border bg-background px-4 py-3 text-sm outline-none focus:border-brand"
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  placeholder="Previous EU-funded project experience required"
                  className="w-full rounded-xl border border-border bg-background px-4 py-3 text-sm outline-none focus:border-brand"
                />
              </div>
            </div>
        ...
        <div className="space-y-6">
          ...
          <section className="rounded-2xl border border-border bg-surface p-6 shadow-sm">
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-text-secondary">
                  Choose whether only you or your whole organization can access this mission.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="rounded-lg bg-background p-2 text-text-primary">
                    <Lock className="h-4 w-4" />
                  </div>
                  <div>
                    <p className="text-sm font-medium text-text-primary">Private mission</p>
                    <p className="mt-1 text-sm text-text-secondary">
                      Only you can see and manage this mission.
                    </p>
                  </div>
                </div>
              </button>
              ...
              <button
                type="button"
                onClick={() => updateField("visibility", "ORGANIZATION")}
                className={`w-full rounded-xl border p-4 text-left transition ${
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-text-secondary">
                      All recruiters in your organization can view this mission and its candidates.
                    </p>
                  </div>
                </div>
              </button>
          ...
          <section className="rounded-2xl border border-border bg-surface p-6 shadow-sm">
            ...
            <ul className="mt-4 space-y-3 text-sm text-text-secondary">
              ...
              <li>• Private = only you. Shared = all recruiters in your organization.</li>
            </ul>
          </section>
        </div>
      </form>
